<?php $pageid = "../TransactionEdit/index.php"; ?>
...
<div class="content-main">
	...
	<div class="banner">
		<h2>
			...
			<a href="<?php echo $pageid; ?>">Transaccion a editar</a>
		</h2>
	</div>
	...
	<div class="grid-form">
 		<div class="grid-form1">
	 		<h3 id="forms-example" class="">Transaccion a editar</h3>
