<?php
	$data_relation = "ticketsFinalizados";
	...
	function fnTraerDatos(){
		...
		$query = "CALL `sp_waitingqueuebybarber_show_employee_user_where_state`(3, " . $tabla[2][0] . " );";
	...
	function fnTraerDatosWhere($where){
		$tabla = fnTraerCodigoUsusario();
		$query = "CALL `sp_waitingqueuebybarber_show_employee_user_where_state_another`('%" . $where . "%', 3, " . $tabla[2][0] . ");";
