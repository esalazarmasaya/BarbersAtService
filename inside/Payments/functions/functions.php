<?php
	...
	if (isset($_POST['btn_edit_data_of_table'])){
		...
		header("Location: ../TicketsInitialized/index.php ",TRUE,301);
	}
	...
	function fnTraerDatos(){
		...
		$query = "CALL `sp_Payments_admin_show`();";
		...
		$tabla[1][0] = "Código de pago";
		$tabla[1][1] = "Primer nombre";
		$tabla[1][2] = "Apellido";
		$tabla[1][3] = "Email";
		$tabla[1][4] = "Fecha Inicio";
		$tabla[1][5] = "Fecha de pago";
		$tabla[1][6] = "Se Debe";
		$tabla[1][7] = "Pagado";
		$tabla[1][8] = "Transaccion";
	...
	function fnCrearTablaHtmlDeTablaProduct(){
		...
		$tabla[1][2] = "Apellido";
		$tabla[1][3] = "Email";
		$tabla[1][4] = "Fecha Inicio Labores";
		$tabla[1][5] = "Fecha de pago";
		$tabla[1][6] = "Se Debe";
		$tabla[1][7] = "Pagado";
		$tabla[1][8] = "Transaccion";
		...
		$colNameId[1] = "txt_employee_first_Name";
		$colNameId[2] = "txt_employee_first_last_name";
		$colNameId[3] = "txt_employee_email";
		$colNameId[4] = "txt_employee_initial_date";
		$colNameId[5] = "txt_payment_date";
		$colNameId[6] = "txt_Not_payed";
		$colNameId[7] = "txt_Payed";
		$colNameId[8] = "txt_transaction_code";
					...
					<div class="mailbox-content">
						...
						for($filas = $initial_row; $filas <= $final_row ; $filas++)
						{
							$value = $value . '
									...
									$value = $value . '<td class="table-text"><h6>' . $tabla[$filas][1] . " " . $tabla[$filas][2] . " (" . $tabla[$filas][3] . ")" . '</h6></td>';
